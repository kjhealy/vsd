...
`r chunq_reveal("reveal-nycfrench", smallcode=TRUE,  lcolw="40", rcolw="60", title = "Let's make a summary table")`
...
`r chunq_reveal("reveal-bulldogmap",  smallcode = TRUE, lcolw="40", rcolw="60", title = "First cut at a map")`
...
`r chunq_reveal("reveal-bulldogmap2", smallcode=TRUE, lcolw="40", rcolw="60", title = "Use a different palette")`
...
`r chunq_reveal("reveal-bulldogzeros",  lcolw="40", rcolw="60", smallcode=TRUE, title = "Keep the Zero count zips")`
...
`r chunq_reveal("reveal-bulldogfb2", smallcode=TRUE,  lcolw="40", rcolw="60", title = "Now redraw the map")`
