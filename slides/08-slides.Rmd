...
# Centered Moving Averages with .kjh-yellow[`slider`]
...
- .small[See how we lose observations as our window widens.]
...
- .small[Doing it this way---e.g. taking a yearly average of 12 monthly values---means all the seasonality is averaged away.] 
...
# A Centered Moving Average, order 60 (i.e. 5 years)
...
- .small[The wider the window, the flatter the line. And we continue to lose observations.]
