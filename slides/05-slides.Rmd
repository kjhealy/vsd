...
---
`r chunk_reveal("reveal-onetablevar", widths = c(35,65), title = "# Count up by one column or variable")`
...
```{r 05-work-with-dplyr-and-geoms-84 }
gss_sm |> 
  select(madeg, padeg)
```
...
# .kjh-green[`arrange()`] and .kjh-green[`slice()`]
