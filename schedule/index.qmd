...
- [**Content**](/content/) ({{< fa book-open-reader >}}): This page contains the readings and other material for each week. Read these **before** class.

- [**Example**](/example/) ({{< fa laptop-code >}}): This page contains annotated R code and other supplementary information that you can use as a reference for your assignments and projects. 

- [**Assignment**](/assignment/) ({{< fa pen-ruler >}}): This page contains the instructions for each assignment. Assignments are due _Tuesdays_ by *6:00pm*. The midterm and final projects are due by *11:59 PM* on the day they're listed.
