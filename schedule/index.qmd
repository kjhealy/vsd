...
- [**Assignment**](/assignment/) ({{< fa pen-ruler >}}) links: These pages contain the instructions for each problem set. The problem set problem set assiged in any given week is due the following _Tuesday_ by *6:00pm*. The midterm and final projects are due by *11:59 PM* on the day they're listed.
